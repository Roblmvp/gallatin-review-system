  ...
  try {
    ...
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        html: "<div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;\"><div style=\"background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;\"><h1 style=\"color: white; margin: 0; font-size: 24px;\">🔐 Password Reset Request</h1></div><div style=\"background: #f8fafc; padding: 30px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 12px 12px;\"><p style=\"font-size: 16px; color: #334155; margin-bottom: 20px;\">A password reset has been requested for the following admin account:</p><div style=\"background: white; padding: 20px; border-radius: 8px; border: 1px solid #e2e8f0; margin-bottom: 20px;\"><p style=\"margin: 0 0 10px 0;\"><strong>Name:</strong> " + userName + "</p><p style=\"margin: 0 0 10px 0;\"><strong>Email:</strong> " + userEmail + "</p><p style=\"margin: 0;\"><strong>Time:</strong> " + timestamp + " CT</p></div><p style=\"font-size: 14px; color: #64748b; margin-bottom: 20px;\">To reset this user's password, go to the Super Admin panel at:<br><a href=\"https://gallatincdjr.reviews/superadmin\" style=\"color: #dc2626;\">https://gallatincdjr.reviews/superadmin</a></p><div style=\"background: #fef3c7; padding: 15px; border-radius: 8px; border: 1px solid #f59e0b;\"><p style=\"margin: 0; font-size: 14px; color: #92400e;\">⚠️ If you did not expect this request, someone may be trying to access the admin panel.</p></div></div><p style=\"text-align: center; font-size: 12px; color: #94a3b8; margin-top: 20px;\">Gallatin CDJR Admin Dashboard • Part of the WE Auto Family</p></div>",
      }),
    });
