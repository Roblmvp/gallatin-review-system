...
export const metadata: Metadata = {
  title: "Gallatin CDJR | Review & Performance System",
  description: "Drive more Google reviews, track sales performance, and boost customer retention with our all-in-one dealership platform.",
};
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#0a0a0f", color: "#fff", fontFamily: "'SF Pro Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ position: "relative", overflow: "hidden", padding: "0 24px" }}>
        ...
        <nav style={{ position: "relative", maxWidth: 1200, margin: "0 auto", padding: "24px 0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <img src="https://res.cloudinary.com/di5ujiwjp/image/upload/v1769874514/Gallatin_CDJR_App_Icon_xt3irp.png" alt="Gallatin CDJR" style={{ height: 48, borderRadius: 10 }} />
            <div>
              <div style={{ fontSize: 20, fontWeight: 700, letterSpacing: "-0.5px" }}>Gallatin CDJR</div>
              <div style={{ fontSize: 11, color: "#64748b", textTransform: "uppercase", letterSpacing: "1px" }}>Review System</div>
            </div>
          </div>
          <div style={{ display: "flex", gap: 12 }}>
            <Link href="/sales" style={{ padding: "10px 20px", fontSize: 14, fontWeight: 500, color: "#94a3b8", textDecoration: "none", borderRadius: 8, transition: "color 0.2s" }}>Sales Portal</Link>
            <Link href="/admin" style={{ padding: "10px 24px", fontSize: 14, fontWeight: 600, background: "linear-gradient(135deg, #dc2626 0%, #b91c1c 100%)", color: "#fff", textDecoration: "none", borderRadius: 8, boxShadow: "0 4px 12px rgba(220, 38, 38, 0.3)" }}>Admin Login</Link>
          </div>
        </nav>
        ...
        <div style={{ position: "relative", maxWidth: 1200, margin: "0 auto", padding: "80px 0 100px", textAlign: "center" }}>
          <div style={{ display: "inline-block", padding: "8px 16px", backgroundColor: "rgba(220, 38, 38, 0.1)", border: "1px solid rgba(220, 38, 38, 0.2)", borderRadius: 100, fontSize: 13, fontWeight: 500, color: "#f87171", marginBottom: 24 }}>
            ⭐ Trusted by Gallatin CDJR Sales Team
          </div>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/admin" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "16px 32px", fontSize: 16, fontWeight: 600, background: "linear-gradient(135deg, #dc2626 0%, #b91c1c 100%)", color: "#fff", textDecoration: "none", borderRadius: 12, boxShadow: "0 8px 24px rgba(220, 38, 38, 0.4)", transition: "transform 0.2s, box-shadow 0.2s" }}>
              Get Started <span style={{ fontSize: 20 }}>→</span>
            </Link>
            <Link href="/review/robert" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "16px 32px", fontSize: 16, fontWeight: 600, backgroundColor: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", textDecoration: "none", borderRadius: 12, transition: "background 0.2s" }}>
              View Demo Page
            </Link>
          </div>
        </div>
      ...
      <div style={{ backgroundColor: "rgba(15, 23, 42, 0.5)", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 24px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 32, textAlign: "center" }}>
          ...
          <div>
            <div style={{ fontSize: 48, fontWeight: 800, background: "linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>16</div>
            <div style={{ fontSize: 14, color: "#64748b", marginTop: 4 }}>Active Salespeople</div>
          </div>
          <div>
            ...
            <div style={{ fontSize: 14, color: "#64748b", marginTop: 4 }}>Average Rating</div>
          </div>
          <div>
            <div style={{ fontSize: 48, fontWeight: 800, background: "linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>24/7</div>
            <div style={{ fontSize: 14, color: "#64748b", marginTop: 4 }}>Always Available</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "100px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24 }}>
          {/* Feature 1 */}
          <div style={{ backgroundColor: "rgba(30, 41, 59, 0.5)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: 20, padding: 32, transition: "transform 0.2s, border-color 0.2s" }}>
      ...
      {/* CTA Section */}
      <div style={{ backgroundColor: "rgba(220, 38, 38, 0.05)", borderTop: "1px solid rgba(220, 38, 38, 0.1)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 18, color: "#94a3b8", marginBottom: 32 }}>Join Gallatin CDJR and see results in your first week.</p>
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/admin" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "16px 32px", fontSize: 16, fontWeight: 600, background: "linear-gradient(135deg, #dc2626 0%, #b91c1c 100%)", color: "#fff", textDecoration: "none", borderRadius: 12, boxShadow: "0 8px 24px rgba(220, 38, 38, 0.4)" }}>
              Access Admin Portal
            </Link>
            <Link href="/sales" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "16px 32px", fontSize: 16, fontWeight: 600, backgroundColor: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", textDecoration: "none", borderRadius: 12 }}>
              Sales Login
            </Link>
          </div>
        </div>
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.05)", padding: "40px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <img src="https://res.cloudinary.com/di5ujiwjp/image/upload/v1769874514/Gallatin_CDJR_App_Icon_xt3irp.png" alt="Gallatin CDJR" style={{ height: 36, borderRadius: 8 }} />
            <div style={{ fontSize: 14, color: "#64748b" }}>© 2026 Gallatin CDJR • Part of the WE Auto Family</div>
          </div>
          <div style={{ display: "flex", gap: 24 }}>
            <Link href="/sales" style={{ fontSize: 14, color: "#64748b", textDecoration: "none" }}>Sales Portal</Link>
            <Link href="/admin" style={{ fontSize: 14, color: "#64748b", textDecoration: "none" }}>Admin</Link>
            <Link href="/tv" style={{ fontSize: 14, color: "#64748b", textDecoration: "none" }}>TV Display</Link>
          </div>
        </div>
      </footer>
    </div>
