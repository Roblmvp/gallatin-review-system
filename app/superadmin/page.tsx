    ...
    return (
      <div style={{ minHeight: "100vh", backgroundColor: "#0a0a0f", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 20, position: "relative", fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif" }}>
        ...
        <div style={{ position: "relative", backgroundColor: "rgba(15, 23, 42, 0.9)", backdropFilter: "blur(24px)", borderRadius: 24, padding: "48px 44px", width: "100%", maxWidth: 400, border: "1px solid rgba(139, 92, 246, 0.3)", boxShadow: "0 32px 64px rgba(0, 0, 0, 0.5)" }}>
          <div style={{ textAlign: "center", marginBottom: 24 }}><span style={{ fontSize: 48 }}>🔐</span></div>
          ...
          {error && <div style={{ padding: "12px 16px", backgroundColor: "rgba(239, 68, 68, 0.15)", border: "1px solid rgba(239, 68, 68, 0.3)", borderRadius: 8, marginBottom: 20, color: "#fca5a5", fontSize: 14 }}>⚠️ {error}</div>}
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#0f172a", color: "#fff" }}>
      <div style={{ background: "linear-gradient(135deg, #1e293b 0%, #0f172a 100%)", padding: "20px 24px", borderBottom: "1px solid #334155" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div><h1 style={{ fontSize: 24, fontWeight: 700, margin: 0 }}>🔐 Super Admin Control Panel</h1><p style={{ fontSize: 14, color: "#94a3b8", margin: "4px 0 0 0" }}>Manage Users & Monitor Activity</p></div>
          <button onClick={handleLogout} style={{ padding: "10px 20px", backgroundColor: "#334155", color: "#fff", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: "pointer" }}>🚪 Logout</button>
        </div>
      </div>
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "24px 24px 0" }}>
        <div style={{ display: "flex", gap: 8, backgroundColor: "#1e293b", padding: 6, borderRadius: 12 }}>
          <button onClick={() => setActiveTab("admins")} style={{ padding: "12px 24px", backgroundColor: activeTab === "admins" ? "#8b5cf6" : "transparent", color: activeTab === "admins" ? "#fff" : "#94a3b8", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 500, cursor: "pointer" }}>🔐 Admin Users ({adminUsers.length})</button>
          <button onClick={() => setActiveTab("salespeople")} style={{ padding: "12px 24px", backgroundColor: activeTab === "salespeople" ? "#8b5cf6" : "transparent", color: activeTab === "salespeople" ? "#fff" : "#94a3b8", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 500, cursor: "pointer" }}>👥 Salespeople ({salespersonUsers.length})</button>
          <button onClick={() => setActiveTab("activity")} style={{ padding: "12px 24px", backgroundColor: activeTab === "activity" ? "#8b5cf6" : "transparent", color: activeTab === "activity" ? "#fff" : "#94a3b8", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 500, cursor: "pointer" }}>📋 Activity Log</button>
        </div>
      </div>
