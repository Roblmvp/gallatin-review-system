      ...
      <div className="demo-page">
        ...
        <div style={{ backgroundColor: "#f8fafc", borderTop: "1px solid #e2e8f0", borderBottom: "1px solid #e2e8f0" }}>
          <div className="stats-grid">
            <div>
              <div className="stat-number" style={{ color: "#dc2626" }}>+47%</div>
              <div style={{ fontSize: 14, color: "#64748b", marginTop: 4 }}>More Google Reviews</div>
            </div>
            <div>
              <div className="stat-number" style={{ color: "#2563eb" }}>+31%</div>
              <div style={{ fontSize: 14, color: "#64748b", marginTop: 4 }}>Service Retention</div>
            </div>
            <div>
              <div className="stat-number" style={{ color: "#16a34a" }}>+18%</div>
        ...
        <div id="testimonials" className="section-padding" style={{ backgroundColor: "#f8fafc", padding: "100px 24px" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 64 }}>
              <h2 className="section-title" style={{ color: "#0f172a" }}>What Dealers Are Saying</h2>
            </div>
        ...
        <div className="section-padding" style={{ maxWidth: 800, margin: "0 auto", padding: "100px 24px" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <h2 className="section-title" style={{ color: "#0f172a" }}>Frequently Asked Questions</h2>
          </div>
